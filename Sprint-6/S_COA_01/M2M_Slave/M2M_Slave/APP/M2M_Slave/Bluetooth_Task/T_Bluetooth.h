...
typedef enum {T_BT_INIT,T_BT_CONFIGREAD,T_BT_CONFIGSET,T_BT_CONNECTED,T_BT_HANDSHAKE,T_BT_DEVICEPACKET,
			  T_BT_PASSDATA,T_BT_KEYPADDATA,T_BT_IDLE,T_BT_Pass,T_BT_FAIL,T_BT_INVALID}enuBTStates_t;
