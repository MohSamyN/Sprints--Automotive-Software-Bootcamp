...
enuErrorStatus_t SevenSegment_Init(void)
{
	...
	DIO_PinInit(SEG_A,OUTPUT,NO_CONNECTION);
	DIO_PinInit(SEG_B,OUTPUT,NO_CONNECTION);
	DIO_PinInit(SEG_C,OUTPUT,NO_CONNECTION);
	DIO_PinInit(SEG_D,OUTPUT,NO_CONNECTION);
	DIO_PinInit(SEG_EN1,OUTPUT,NO_CONNECTION);
	DIO_PinInit(SEG_EN2,OUTPUT,NO_CONNECTION);
...
enuErrorStatus_t SevenSegment_WriteNum(uint8_t num)
{
	...
	DIO_PinWrite(SEG_EN2,HIGH);
	#elif SSEG_MODE == COMMON_ANODE
	DIO_PinWrite(SEG_EN2,LOW);
	#endif
	...
	/* Latching the EN pin */
	#if SSEG_MODE == COMMON_CATHODE
	DIO_PinWrite(SEG_EN1,HIGH);
	#elif SSEG_MODE == COMMON_ANODE
	DIO_PinWrite(SEG_EN1,LOW);
	#endif
...
static enuErrorStatus_t SevenSegment_Decode(uint8_t num)
{
	...
	switch(num)
	{
		...
		case SEG_0:
			...
			#if SSEG_MODE == COMMON_CATHODE
			DIO_PinWrite(SEG_A, LOW);
			DIO_PinWrite(SEG_B, LOW);
			DIO_PinWrite(SEG_C, LOW);
			DIO_PinWrite(SEG_D, LOW);
			#elif SSEG_MODE == COMMON_ANODE
			DIO_PinWrite(SEG_A, HIGH);
			DIO_PinWrite(SEG_B, HIGH);
			DIO_PinWrite(SEG_C, HIGH);
			DIO_PinWrite(SEG_D, HIGH);
			#endif			
			break;
